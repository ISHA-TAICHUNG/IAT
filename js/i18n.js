...
const I18N = {
  ...
  'fb.desc': { 'zh-TW': '補充說明（建議填寫）', vi: 'Mô tả thêm (nên điền)', id: 'Keterangan tambahan (disarankan)', th: 'รายละเอียดเพิ่มเติม (แนะนำให้กรอก)', en: 'Additional details (recommended)' },
  'fb.placeholder': { 'zh-TW': '例：缺圖、答案我覺得是 X、選項看不懂…', vi: 'Ví dụ: thiếu hình, đáp án nên là X, không hiểu lựa chọn…', id: 'Contoh: tidak ada gambar, jawaban seharusnya X, opsi tidak jelas…', th: 'ตัวอย่าง: ไม่มีรูป คำตอบควรเป็น X ไม่เข้าใจตัวเลือก…', en: 'Example: missing image, answer should be X, unclear option…' },
  ...
  'result.btn.review': { 'zh-TW': '📝 練習未掌握', vi: '📝 Ôn câu chưa nắm', id: '📝 Latih yang belum dikuasai', th: '📝 ฝึกข้อที่ยังไม่ผ่าน', en: '📝 Practice unmastered' },
  ...
  'nav.query': { 'zh-TW': '🔍 管理職類查詢', vi: '🔍 Tra cứu lịch thi', id: '🔍 Cari Jadwal', th: '🔍 ค้นหาตารางสอบ', en: '🔍 Exam Schedule' },
  'nav.examQuery': { 'zh-TW': '🛠️ 即測即評查詢', vi: '🛠️ Tra cứu thi ngay', id: '🛠️ Cari Tes Instan', th: '🛠️ ค้นหาทดสอบ', en: '🛠️ Instant Test' },
